...
<td width="50%"> &nbsp;&nbsp;&nbsp;<input type="text" name="username" style="border:none" size="7"> </td>
</tr>
<tr bgcolor=#FFFFFF>
...
<td width="50%"> &nbsp;&nbsp;&nbsp;<input type="text" name="password" style="border:none" size="7" value="123456"> </td>
</tr>
