...
<form name="form1" method="post" action="passwd update.jsp?username=<%=username%>">
...
<td width="50%"> &nbsp;&nbsp;&nbsp;<input type="text" name="password" style="border:none"  size="7" value=<%=rs.getObject(2) %>> </td>
</tr>
